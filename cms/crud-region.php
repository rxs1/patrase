  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li ><a href="crud-category.php"><i class="fa fa-link"></i> <span>CRUD Category</span></a></li>
		  <li class="active"><a href="crud-region.php"><i class="fa fa-link"></i> <span>CRUD Region</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
